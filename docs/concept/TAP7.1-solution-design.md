...
- **Modular Installation Package:** A set of HELM charts for deploying the enablement service bundles:
    ...
    - **Data Persitence Layer Bundle:** Including a simple Submodel Server to store semantic data.
...
| 7.1.1.13       | Solution Concept                                                                                                                                                                                                                                                                                                                                     | Creation of a solution design for the “Hausanschluss” Bundle.                                                                                                                                                                                                                                                                                                                                                                                                                                                    | The solution design for the "Hausanschluss" Bundle is created. <br>The solution design for the "Hausanschluss" Bundle ispublished in the repository: https://github.com/eclipse-tractusx/tractus-x-umbrella.                                                                                                                                                                                                         |
...
| 3   | SMEs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Data Consumer <br/> Data Provider <br/> Enablement Service Provider |                                                                                                                                                                                                                                                                                                         | Need: SMEs developing a service within the Catena-X Data space want an environent to develop and test their service against without the need for expensive SaaS solutions.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
