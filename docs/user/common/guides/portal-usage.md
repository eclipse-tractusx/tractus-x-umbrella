...
> **Note**
> In case that you have TLS enabled (see [Self-signed TLS setup (Optional)](../network/tls.md)), make sure to accept the risk of the self-signed certificates for all the hosts before performing the first login:
>
...
For more details on Portal configuration, refer to the [Installation Reference](../installation.md).
