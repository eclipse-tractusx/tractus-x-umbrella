...
See the [umbrella chart structure](/docs/user/common/installation.md#available-components) to understand how the "Hausanschluss" Bundles, `tx-data-provider` and other charts depend on each other.
